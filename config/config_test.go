...
import (
	...
	"github.com/cornerstone-labs/acorus/common/testlog"
...
func TestLoadConfig(t *testing.T) {
	...
	require.Equal(t, conf.MasterDB.Host, "127.0.0.1")
	require.Equal(t, conf.MasterDB.Port, 5432)
	require.Equal(t, conf.MasterDB.User, "postgres")
	require.Equal(t, conf.MasterDB.Password, "postgres")
	require.Equal(t, conf.MasterDB.Name, "acorus")
