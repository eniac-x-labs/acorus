...
func (c *appChainServiceClient) L2UnStakeRecord(ctx context.Context, in *L2UnStakeRecordRequest, opts ...grpc.CallOption) (*L2UnStakeRecordResponse, error) {
	out := new(L2UnStakeRecordResponse)
	err := c.cc.Invoke(ctx, "/acorus.rpc.appchain.AppChainService/L2UnStakeRecord", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *appChainServiceClient) L2StakeRecord(ctx context.Context, in *L2StakeRecordRequest, opts ...grpc.CallOption) (*L2StakeRecordResponse, error) {
	out := new(L2StakeRecordResponse)
	err := c.cc.Invoke(ctx, "/acorus.rpc.appchain.AppChainService/L2StakeRecord", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAppChainServiceServer) L2UnStakeRecord(context.Context, *L2UnStakeRecordRequest) (*L2UnStakeRecordResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method L2UnStakeRecord not implemented")
}
...
func _AppChainService_L2UnStakeRecord_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(L2UnStakeRecordRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AppChainServiceServer).L2UnStakeRecord(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/acorus.rpc.appchain.AppChainService/L2UnStakeRecord",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppChainServiceServer).L2UnStakeRecord(ctx, req.(*L2UnStakeRecordRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AppChainService_L2StakeRecord_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(L2StakeRecordRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AppChainServiceServer).L2StakeRecord(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/acorus.rpc.appchain.AppChainService/L2StakeRecord",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppChainServiceServer).L2StakeRecord(ctx, req.(*L2StakeRecordRequest))
	}
	return interceptor(ctx, in, info, handler)
}
