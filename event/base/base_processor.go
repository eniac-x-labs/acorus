...
import (
	...
	"github.com/cornerstone-labs/acorus/event/base/bridge"
	"github.com/cornerstone-labs/acorus/event/base/stateroot"
)
...
func NewBridgeProcessor(db *database.DB, l1StartHeight *big.Int, l2StartHeight *big.Int,
	...
	epoch uint64, l1ChainId, l2ChainId string, isMainnet bool) (*BaseEventProcessor, error) {
...
func (ep *BaseEventProcessor) onL1Data() error {
	var errs error
...
func (ep *BaseEventProcessor) onL2Data() error {
	var errs error
...
func (ep *BaseEventProcessor) processInitiatedL1Events() error {
...
func (ep *BaseEventProcessor) processInitiatedL2Events() error {
...
func (ep *BaseEventProcessor) processProvenL1Events() error {
...
func (ep *BaseEventProcessor) processFinalizedL1Events() error {
...
func (ep *BaseEventProcessor) processFinalizedL2Events() error {
...
func (ep *BaseEventProcessor) processRollupStateRoot() error {
