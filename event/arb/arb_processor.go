...
func (pp *ArbEventProcessor) StartUnpack() error {
...
func (pp *ArbEventProcessor) ClosetUnpack() error {
	pp.resourceCancel()
	return pp.tasks.Wait()
}

func (pp *ArbEventProcessor) onL1Data() error {
...
func (pp *ArbEventProcessor) onL2Data() error {
...
func (pp *ArbEventProcessor) l1EventsFetch(fromL1Height, toL1Height *big.Int) error {
...
func (pp *ArbEventProcessor) l2EventsFetch(fromL1Height, toL1Height *big.Int) error {
...
func (pp *ArbEventProcessor) l1EventUnpack(event event.ContractEvent) error {
