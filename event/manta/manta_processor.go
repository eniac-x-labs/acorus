...
import (
	...
	"github.com/cornerstone-labs/acorus/event/manta/bridge"
	"github.com/cornerstone-labs/acorus/event/manta/stateroot"
)

type MantaEventProcessor struct {
	db                          *database.DB
...
func NewBridgeProcessor(db *database.DB, l1StartHeight *big.Int, l2StartHeight *big.Int,
	...
	epoch uint64, l1ChainId, l2ChainId string, isMainnet bool) (*MantaEventProcessor, error) {
...
func (ep *MantaEventProcessor) StartUnpack() error {
...
func (ep *MantaEventProcessor) ClosetUnpack() error {
	ep.resourceCancel()
	return ep.tasks.Wait()
}

func (ep *MantaEventProcessor) onL1Data() error {
	var errs error
...
func (ep *MantaEventProcessor) onL2Data() error {
	var errs error
...
func (ep *MantaEventProcessor) processInitiatedL1Events() error {
...
func (ep *MantaEventProcessor) processProvenL1Events() error {
...
func (ep *MantaEventProcessor) processFinalizedL1Events() error {
...
func (ep *MantaEventProcessor) processFinalizedL2Events() error {
...
func (ep *MantaEventProcessor) processRollupStateRoot() error {
