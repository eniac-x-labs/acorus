...
func (sp *ScrollProcessor) l1EventUnpack(event event.L1ContractEvent) (*worker.L1ToL2, error) {
...
func (sp *ScrollProcessor) l2EventUnpack(event event.L2ContractEvent) (*worker.L2ToL1, error) {
	switch event.EventSignature.String() {
