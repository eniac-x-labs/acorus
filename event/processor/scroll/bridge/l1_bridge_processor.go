...
//func L1SentMessageEvent(event event.ContractEvent, db *database.DB) (*worker.L1ToL2, error) {
//	rlpLog := event.RLPLog
...
//func L1RelayedMessageEvent(event event.ContractEvent, db *database.DB) (*worker.L1ToL2, error) {
//	rlpLog := event.RLPLog
