...
CREATE INDEX IF NOT EXISTS base_l1_to_l2_timestamp ON base_l1_to_l2(timestamp);
CREATE INDEX IF NOT EXISTS base_l1_to_l2_l1_transaction_hash ON base_l1_to_l2(l1_transaction_hash);
CREATE INDEX IF NOT EXISTS base_l1_to_l2_l2_transaction_hash ON base_l1_to_l2(l2_transaction_hash);
CREATE INDEX IF NOT EXISTS base_l1_to_l2_from_address ON base_l1_to_l2(from_address);
...
CREATE INDEX IF NOT EXISTS base_l2_to_l1_timestamp ON base_l2_to_l1(timestamp);
CREATE INDEX IF NOT EXISTS base_l2_to_l1_l2_transaction_hash ON base_l2_to_l1(l2_transaction_hash);
CREATE INDEX IF NOT EXISTS base_l2_to_l1_l1_prove_tx_hash ON base_l2_to_l1(l1_prove_tx_hash);
CREATE INDEX IF NOT EXISTS base_l2_to_l1_l1_finalize_tx_hash ON base_l2_to_l1(l1_finalize_tx_hash);
CREATE INDEX IF NOT EXISTS base_l2_to_l1_from_address ON base_l2_to_l1(from_address);
CREATE INDEX IF NOT EXISTS base_l2_to_l1_to_address ON base_l2_to_l1(to_address);
CREATE INDEX IF NOT EXISTS base_l2_to_l1_message_hash ON base_l2_to_l1(message_hash);
CREATE INDEX IF NOT EXISTS base_l2_to_l1_withdraw_transaction_hash ON base_l2_to_l1(withdraw_transaction_hash);

CREATE TABLE IF NOT EXISTS base_state_root (
      guid                      VARCHAR PRIMARY KEY,
